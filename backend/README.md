...
## Project Structure
    ...
    ├── testingnewapp_dev_37871  # Django project configurations
...
1. Clone this repo and `cd testingnewapp_dev_37871`
...
2. Clone this repo and `cd testingnewapp_dev_37871`
